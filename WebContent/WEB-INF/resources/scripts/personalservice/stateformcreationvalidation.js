...
//    for(var rad1=0;rad1<document.lltAL[radioName].length;rad1++){
//    if(document.lltAL[radioName][rad1].checked){
//    radioValue=document.lltAL[radioName][rad1].value;
//    resultVal1=true;
...
//     document.lltAL.stateFormHiddenVar.value="Finished";
//    }
