<%--
    Document   : ForeignQualificationsNew
...
<html>    
    <head>
    <title>Foreign Qualifications | legalnod.com</title>
    <meta charset="UTF-8"/>
    ...
    <![endif]-->
		...
		<div class="col-md-12">
		<div class="white-background" style="min-height: 645px;height: auto;">
		<div class="docCenter">
		<div>
		<div class="row">
		<div class="col-md-3">
		...
		<ul>
		<li><a class="doc-active-header" href="#">  Foreign Qualifications </a></li>
		...
		<h2><span class="pull-left">Foreign Qualifications</span>
		...
		<p>Filing for <strong>Foreign Qualification</strong> allows a company to legally conduct business in another state other than the state of formation. A company may be required to qualify as a foreign entity in a state where the business has physical presence or business operations. Failing to qualify in a state where qualification is necessary may result in penalties, which may include fines as well as inability to bring forth a lawsuit in the state the company is not qualified in.</p>		
		<div class="ul-li">
		<p><b>How to qualify to do business in another state*:</b></p>
		<ul>
		<li>File for Foreign Qualification in desired state</li>
		<li>Obtain necessary licenses and permits for your business</li>
		<li>Abide by state tax filings</li>
		</ul>		
		</div>
		
		<p style="text-align:right; font-style:italic">*Please note that your state's requirements may vary.</p>
		<div class="topbrdr">
		<p>When you file for Foreign Qualification using LegalNod's services, we offer you a free service of <strong>Business Name Availability Check.</strong> (If your original registered name is unavailable in the state you are seeking foreign qualification, you may be required to adopt a new name.)</p>
		
		<form name="docCenterFormName" id="docCenterFormId" action="#" method="get">
		<h4 class="pull-left" style="margin-top: 25px;height: 35px;">
		<button class="submit-butt-doc" type="submit" onMouseOver="document.getElementById('doc-llc-sub-but').src='resources/images/SSImgs/GetStartedDocMOImg.png';" onMouseOut="document.getElementById('doc-llc-sub-but').src='resources/images/SSImgs/GetStartedDocImg.png';" ><img id="doc-llc-sub-but" src="resources/images/SSImgs/GetStartedDocImg.png" alt=""><span class="butt-va-mid">File for Foreign Qualification</span></button></h4>
		</form>
		</div>			
