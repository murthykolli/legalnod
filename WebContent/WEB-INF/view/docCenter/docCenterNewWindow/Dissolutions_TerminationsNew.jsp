<%--
    Document   : Dissolutions_TerminationsNew
...
<html>    
    <head>
    <title>Dissolutions/Terminations | legalnod.com</title>
    <meta charset="UTF-8"/>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
    <meta name="description" content="LegalNod provides you the termination or dissolve service for your business. We services make the process quick & easy."/>
    <meta name="keywords" content="business termination"/>
    
    <link rel="shortcut icon" href="resources/images/BrowserIcon/favicon.ico" type="image/x-icon" />
    <link rel="canonical" href="https://www.legalnod.com/legalnod/DissolutionsTerminationsDocNW"/>    
    ...
    <![endif]-->
		...
		<div class="col-md-12">
		<div class="white-background" style="min-height: 588px;height: auto;">
		<div class="docCenter">
		<div>
		<div class="row">
		<div class="col-md-3">
		
		<div class="left-accourdian" style="padding-bottom: 28px;">
		<h3>DOC CENTER</h3>
		...
		<li><a class="doc-active-header" href="#">  Dissolutions/Terminations </a></li> 
		<li><a href="NameChangeDocNW">  Name Change </a></li>
		<li><a href="ConversionsDocNW">  Conversions </a></li>
		</ul>	
		</li>		
		...
		<h2><span class="pull-left">Dissolutions/Terminations</span>
		...
		<p>In order to dissolve your Corporation or LLC, "Articles of Dissolution" or "Articles of Termination" will need to be filed with the appropriate state agency. It is important that all legal entities be dissolved through formal action. If the business is not dissolved through formal action, you or the entity may be liable to continue to pay taxes and fees.</p>		
		<div class="ul-li">
		<p><b>How to Dissolve or Terminate your business*:</b></p>
		<ul>
		<li>Obtain proper approval from necessary directors, members, partners or shareholders.</li>
		<li>File "Articles of Dissolution" or "Articles of Termination" with appropriate state agency</li>
		<li>Once you obtain state approval for dissolution, distribute assets as necessary.</li>
		</ul>		
		</div>
		
		<p style="text-align:right; font-style:italic">*Please note that your state's requirements may vary.</p>
		<div class="topbrdr">
		<p>If you wish to dissolve your business, LegalNod's services make the process easy and quick!</p>
		
		<form name="docCenterFormName" id="docCenterFormId" action="#" method="get">
		<h4 class="pull-left" style="margin-top: 25px;height: 35px;">
		<button class="submit-butt-doc" type="submit" onMouseOver="document.getElementById('doc-llc-sub-but').src='resources/images/SSImgs/GetStartedDocMOImg.png';" onMouseOut="document.getElementById('doc-llc-sub-but').src='resources/images/SSImgs/GetStartedDocImg.png';" ><img id="doc-llc-sub-but" src="resources/images/SSImgs/GetStartedDocImg.png" alt=""><span class="butt-va-mid">File for a Dissolution</span></button></h4>
		</form>
		</div>			
