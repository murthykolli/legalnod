<%--
    Document   : additionalServicesHide
...
<html>    
    ...
    <link rel="shortcut icon" href="resources/images/BrowserIcon/favicon.ico" type="image/x-icon" />
		...
		<div class="left-accourdian" style="padding-bottom: 455px;">
		...
		<li><img src="resources/images/text-plus.gif" alt=""> <a class="doc-active-header" href="bsAdditionalServices"> Additional Services  </a></li>
		</ul>
