...
<html>    
    ...
    <link rel="shortcut icon" href="resources/images/BrowserIcon/favicon.ico" type="image/x-icon" />
		...
		<div class="col-md-12">
		<div class="white-background" style="min-height: 435px;height: auto;">
		<div class="docCenter">
		<div>
		<div class="row">
		<div class="col-md-3">
		...
		<li><img src="resources/images/text-plus.gif" alt=""> <a class="doc-active-header" href="bsTrademark"> Trademark  </a></li>
