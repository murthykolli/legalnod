...
//  progressBar
    ...
    if(document.federaltax.attributeTextField1.value!==''){
    var legalName = document.federaltax.attributeTextField1.value;
    newAjaxCallJson(legalName);
    } }
    ...
    function newAjaxCallJson(selectedData){    	
    	$.ajax({
			type : 'POST',
			url : "freeJSONFederalTaxLegalName?legalName="+selectedData,
			dataType : 'json',
			async : true,
			cache: false,
		...
		<form action="freeFederalDataModification" method="post" name="federaltax" id="pro-form">            
