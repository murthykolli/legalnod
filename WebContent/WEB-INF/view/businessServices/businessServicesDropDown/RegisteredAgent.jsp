...
<html>    
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Registered Agent";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<div class="col-md-12">
		<div class="white-background" style="min-height: 599px;height: auto;">
		<div class="servicesbystate">
		<div>
		<div class="services-left">
		<h2 class="busServHeading"> Registered Agent</h2>
		<p class="bs-dropdown-LMText"> Learn more about Registered Agents at the  &nbsp;<a href="RegisteredAgentForDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
		...
		<p class="bsStateFeeText"><b class="bar-size">/</b>  year &nbsp;
		</p> </div>		            
