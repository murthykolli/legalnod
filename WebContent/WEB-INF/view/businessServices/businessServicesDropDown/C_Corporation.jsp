...
<html>    
	...
	<meta name="description" content="LegalNod offer company incorporation services to our clients,Learn about the types of business incorporation in general."/>
	<meta name="keywords" content="Business Incorporation Services"/>
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "C Corporation";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> C Corp/ General Corporation</h2>
		<p class="bs-dropdown-LMText"> Learn more about C Corporations at the  &nbsp;<a href="CCorpDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
