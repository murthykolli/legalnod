...
<html>    
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Annual Report";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Annual Reports</h2>
		<p class="bs-dropdown-LMText"> Learn more about Annual Reports at the  &nbsp;<a href="AnnualReportsDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
