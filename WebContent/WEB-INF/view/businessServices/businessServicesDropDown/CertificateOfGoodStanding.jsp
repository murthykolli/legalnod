<%--
    Document   : CertificateOfGoodStanding
...
<html>    
    ...
    <meta name="description" content="Use LegalNod's services to get a Certificate of Good Standing for your company from the appropriate state agency. visit here for more information LegalNod.com"/>
    <meta name="keywords" content="Certificate of Good Standing"/>
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Certificate of Good Standing";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Certificate of Good Standing</h2>
		<p class="bs-dropdown-LMText"> Learn more about Good Standings at the  &nbsp;<a href="CertificateOfGoodStandingForDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
