...
<html>    
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Reinstatement";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Reinstatement of Business</h2>
		<p class="bs-dropdown-LMText"> Learn more about Reinstatement of Bus at the  &nbsp;<a href="ReinstatementOfBusinessForDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
