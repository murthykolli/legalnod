...
<html>    
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Amendments Changes";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Amendments/Changes</h2>
		<p class="bs-dropdown-LMText"> Learn more about Amendments/Changes at the  &nbsp;<a href="AmendmentsChangesDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
