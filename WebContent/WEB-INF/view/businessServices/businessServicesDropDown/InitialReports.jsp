...
<html>    
    ...
    <meta name="description" content="LegalNod helps you to filling an initial business report regarding the location, type of business structure and business activities."/>
    <meta name="keywords" content="filing an initial business report"/>
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Initial Report";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Initial Reports</h2>
		<p class="bs-dropdown-LMText"> Learn more about Initial Reports at the  &nbsp;<a href="InitialReportsDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
