    ...
    function newAjaxPriceCall(selectedData){    	
    	$.ajax({
			...
			success : function(result) {				
				...
				$.lz.Alert({type:"",title:"<img class='aln-st-img' src='resources/images/smallFormNameImg.png'> 501 Application",
						   ...
						   "Our process fee is the lowest.  If you find any other low price, we will reduce <font color='#228B22'><b>5%</b></font> on our process fee. <br><br>", effect:"slideDown,bigger",formID:"fzoFormId"});
				} }); }
    </script>
    </head>    
        <body>
		...
		<h2 class="busServHeading"> 501(c)(3) Application</h2>
		<p class="bs-dropdown-LMText"> Learn more about 501(c)(3) Applications at the  &nbsp;<a href="501c3ApplicationDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
		...
		<form name="fzoFormName" id="fzoFormId" action="applyFiveZeroOneAppBusSer" method="get">
		<table class="form-group">
		<tbody>
		<tr><td><input type="hidden" name="typeOfDocument" value="501App" /></td></tr>  
