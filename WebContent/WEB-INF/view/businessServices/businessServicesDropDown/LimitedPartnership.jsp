...
<html>    
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Limited Partnership</h2>
		<p class="bs-dropdown-LMText"> Learn more about LPs at the  &nbsp;<a href="LimitedPartnershipDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
