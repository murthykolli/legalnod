...
<html>    
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Certified Copies";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Certified Copies</h2>
		<p class="bs-dropdown-LMText"> Learn more about Certified Copies at the  &nbsp;<a href="CertifiedCopiesForDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
