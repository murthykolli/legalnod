    ...
    function newAjaxPriceCall(selectedData){    	
    	$.ajax({
			...
			success : function(result) {				
				...
				$.lz.Alert({type:"",title:"<img class='aln-st-img' src='resources/images/smallFormNameImg.png'> Federal Tax ID ",
						   ...
						   "Our process fee is the lowest.  If you find any other low price, we will reduce <font color='#228B22'><b>5%</b></font> on our process fee. <br><br>", effect:"slideDown,bigger",formID:"fedTaxIdFormId"});
				} }); }
    </script>    
    </head>
        <body>
		...
		<h2 class="busServHeading"> Federal Tax ID (EIN)</h2>
		<p class="bs-dropdown-LMText"> Learn more about Federal Tax IDs at the  &nbsp;<a href="FederalTaxIDDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
		...
		<p><img id="dropdown-newreqdoc" src="resources/images/SSImgs/TextPointerImg.png"> <b>We guarantee that we will obtain your Federal Tax ID (EIN) for you within one business day!</b></p>
		</div> </div>  
		...
		<form name="fedTaxIdFormName" id="fedTaxIdFormId" action="federalTaxIDNumberBusSer" method="get">
		<table class="form-group">
		<tbody>
		<tr><td><input type="hidden" name="typeOfDocument" value="FederalTaxID" /></td></tr>  
