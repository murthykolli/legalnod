...
<html>    
    ...
    if(stateName!==""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Name Reservation";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Name Reservation</h2>
		<p class="bs-dropdown-LMText"> Learn more about Name Reservations at the  &nbsp;<a href="NameReservationDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
