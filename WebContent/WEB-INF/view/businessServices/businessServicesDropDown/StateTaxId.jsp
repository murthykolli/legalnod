...
<html>    
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> State Tax ID</h2>
		<p class="bs-dropdown-LMText"> Learn more about State Tax IDs at the  &nbsp;<a href="StateTaxIDDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
		...
		<tr><td><select id="stateNameId" name="stateName" onchange="llcStateValidation();">
		 ...
		 <tr><td><input type="hidden" name="formName" value="State Tax ID" /></td></tr>	 
