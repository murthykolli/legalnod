<%--
    Document   : Non_ProfitCorporation
...
<html>    
    ...
    <meta name="description" content="Looking for Forming a Non-Profit Corporation. LegalNod offers business name availability check and obtain your federal tax id (ein) services for your business."/>
    <meta name="keywords" content="forming non-profit corporation"/>
    ...
    if(stateName!==""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Nonprofit Corporation";
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Non-Profit Corporation</h2>
		<p class="bs-dropdown-LMText"> Learn more about Non-Profit Corporations at the  &nbsp;<a href="NonProfitCorpDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
