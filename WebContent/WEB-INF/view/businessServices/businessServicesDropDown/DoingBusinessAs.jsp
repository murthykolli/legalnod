...
<html>    
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Doing Business As (DBA)</h2>
		<p class="bs-dropdown-LMText"> Learn more about DBAs at the  &nbsp;<a href="DoingBusinessAsDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
