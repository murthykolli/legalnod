<%--
    Document   : ForeignQualifications
...
<html>    
    ...
    if(stateName !== ""){
    document.getElementById("statelabel").removeAttribute("class");
    var categoryName = "Foreign Qualifications";
    ...
    function newAjaxCall(selectedstate){   
    	$.ajax({
			type : 'POST',
			url : "jSonFQFormSelectionWithState?stateName="+selectedstate,
			dataType : 'json',
			async : true,
			cache: false,
    ...
    function newAjaxPriceCall(selectedData){     	
		...
		<h2 class="busServHeading"> Foreign Qualifications</h2>
		<p class="bs-dropdown-LMText"> Learn more about Foreign Qualifications at the  &nbsp;<a href="ForeignQualificationsDoc" onMouseOver="this.style.color='#3c3c3c';" onMouseOut="this.style.color='#00a9f1';">DOC CENTER</a></p>
