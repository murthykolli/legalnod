<%--
    Document   : stateFormCheckouDisplay
...
<html>    
    ...
    function newAjaxCall(selectedData){    	
		...
		<form action="checkoutDataModification" name="checkoutDisplayForm" id="pro-form" method="get">            
		...
		<input type="hidden" name="stateFormsCheckOutRef"/>
        </form> 
        <div class="clearfix"></div>
		</div> </div>
        ...
        document.checkoutDisplayForm.stateFormsCheckOutRef.value = "CheckoutModification";
        }
        	
        function goToCheckout(){
        document.checkoutDisplayForm.stateFormsCheckOutRef.value = "CheckoutPayment";
        }
        </script>
