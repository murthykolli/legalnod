...
<%--
	Document : businessServicesBLHeader
		  ...
		  <div class="container">
		    <div class="collapse navbar-collapse js-navbar-collapse pull-right">
		      <ul id="menu" class="nav navbar-nav">
		        ...
		        <li class="dropdown active"> <a href="businessServices" class="dropdown-toggle">BUSINESS SERVICES </a> <span data-toggle="dropdown" class="caret"></span>
