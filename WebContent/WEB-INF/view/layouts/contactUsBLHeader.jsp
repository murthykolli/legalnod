		  ...
		  <div class="container">
		    <div class="row">
		      ...
		      <div class="col-md-9 col-xs-8 col-sm-12 text-right">
		        ...
		        <div class="top-login">
		          <p><span><i class="img-user glyphicon glyphicon-phone-alt contus-adjmt" style="color: #3c3c3c"></i><a href="contactUs" style="color: #00a9f1">Contact Us</a></span></p>
