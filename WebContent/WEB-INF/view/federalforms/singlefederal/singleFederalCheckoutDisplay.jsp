<%--
    Document   : singleFederalCheckoutDisplay
...
<html>    
    ...
    function newAjaxCall(selectedData){    	
    	$.ajax({
			type : 'POST',
			url : "federalJSonModifiedValuesUpdate?documentName="+selectedData,
			dataType : 'json',
			async : true,
			cache: false,
		...
		<form action="federalCheckoutDataModification" name="checkoutDisplayForm" id="pro-form" method="get">            
